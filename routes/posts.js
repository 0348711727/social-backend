...
const {createPost, likePost, updatePost, deletePost, getPost, getTimlinePost, getAllUserPost} = require('../controllers/posts')

const auth = require("../middleware/auth");

router.get("/:id", getPost);
router.post("/", auth, createPost);
router.put("/", auth, likePost);
router.put("/:id", auth, updatePost);
router.delete("/:id", auth, deletePost);
router.get("/timeline/:userId",  auth,getTimlinePost);
router.get("/profile/:username", auth, getAllUserPost);
